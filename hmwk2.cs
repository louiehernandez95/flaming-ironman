...
namespace IntroCS
{
  class MainClass
  {
    ...
    static void GradeAssignments()
    {
    	...
    	double grade = ((ExamsWeight * ExamsGrade + HomeworkWeight * HomeworkGrade + LabsWeight * LabsGrade + ProjectWeight * ProjectGrade + ParticipationWeight * ParticipationGrade) / 100.00);
